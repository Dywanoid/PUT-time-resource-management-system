...
from resolvers import query, mutation, client_object, project_object, project_assignment_object, currency_enum, language_enum, holiday_request_type_enum, holiday_request_status_enum
...
resolvers = [
    ...
    client_object,
    project_object,
    project_assignment_object,
    currency_enum,
    language_enum,
    holiday_request_type_enum,
    holiday_request_status_enum
]
